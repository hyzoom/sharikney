...
public final class ServerUtilities {
    ...
    static void sendRandom(final Context context, final String regId, int randNum, String message) {
        String randomUserURL = RANDOM_USER_URL;
//        + "/?regId=" + regId + "&randNum=" + randNum
